...
# 📖 Tabla de Contenidos
  ...
  - [Tarea 5: Resaltar los Píxeles más Brillantes y Oscuros](#)
  - [Tarea 6: Propuesta de Pop Art usando una Cámara Web o Entrada de Video](#)
  - [Invertir los Colores del Flujo de la Cámara](#)
  - [Gradiente Interactivo en la Cámara](#)
  - [Tarea Extra: Resaltar Píxeles Oscuros y Brillantes](#)
  - [Guía de Instalación](#)
...
Anaconda te permite crear diferentes entornos, cada uno con sus propios paquetes y versiones específicas. También puedes cambiar fácilmente entre entornos al trabajar con Visual Studio Code. Para aquellos que prefieren no usar Windows, puedo confirmar que mi experiencia con Miniconda en Linux ha sido similar.
Para ejecutar los notebooks proporcionados en tu computadora después de instalar Anaconda y Visual Studio Code, sigue estos pasos:
1. Inicia Visual Studio Code (en el PC del laboratorio, está disponible en el escritorio).
...
1. Ten tanto Visual Studio Code como el Anaconda Prompt en ejecución.
2. En Visual Studio Code, abre el archivo llamado 'Practica1_SeleneGonzalezCurbelo_MarianaSurosAlvarez.ipynb'.
3. En Visual Studio Code, abre la Paleta de Comandos usando la combinación Ctrl+Shift+P.
4. Selecciona el entorno recién creado escribiendo "Python: Select Interpreter" y eligiendo el creado.
    * En algunas máquinas, al ejecutar el comando anterior, puedes encontrarte con un error como "interpreter not found." Puedes resolver esto seleccionando el modo "Trust" en lugar de "Restricted" en la
...
Una vez que llegues a este punto, deberías poder ejecutar el notebook para esta primera práctica. ¡Cruzamos los dedos, y exploremos las variaciones que encontramos!
